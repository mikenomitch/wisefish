defmodule Wisefish.Accounts.Authentication do
  @moduledoc """
  ...
  use Guardian, otp_app: :wisefish

  alias Wisefish.Accounts.{Credential, User}
  ...
  def resource_from_claims(claims) do
    ...
    user = Wisefish.Accounts.get_user!(subject_id)
    {:ok, user}
  end
